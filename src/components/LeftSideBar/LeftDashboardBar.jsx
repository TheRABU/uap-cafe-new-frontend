          ...
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            ...
            <li>
              ...
              >
                ...
                <span>My custom food request </span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span>Add a custom food request </span>
              </Link>
            </li>
          </ul>
          <br />
              ...
              <ul className="pt-4 pb-2 space-y-1 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span>Add new Food Item for sale</span>
                  </Link>
                  <Link
                    rel="noopener noreferrer"
                    to="/seller-view-foods"
                    className="flex items-center p-2 space-x-3 rounded-md"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>View seller's added foods</span>
                  </Link>
                </li>
                <li>
                  <button
